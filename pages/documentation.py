...
def documentation_gui(root):
    ...
    """
    title_label = ttk.Label(root, text='Documentation', font=('Helvetica', 16, 'bold'), background="#dcdad5")
    ...
    m_html = markdown.markdown(content).replace("/static/images/screenshot.png", f"{os.getcwd()}/static/images/screenshot.png")
